...
import {itemDataForme} from "../../../app/data/protocol";
...
export class TodoListService {
 ...
 /* SERVER_UPDATE_LIST_NAME(ListID: ListID, newName: string) {
    const op: SERVER_UPDATE_LIST_NAME = { type: "SERVER_UPDATE_LIST_NAME", ListID: ListID, name: newName };
  }*/
  /*****************************************************************************************************************************************
   * Operations on items *******************************************************************************************************************
   ****************************************************************************************************************************************/
